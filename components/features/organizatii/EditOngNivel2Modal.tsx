    ...
    <ModalOverlay labelledBy="edit-ong-nivel2-title">
      <div className="bg-white rounded-2xl w-full max-w-lg max-h-[85vh] flex flex-col">
        <div className="px-6 py-5 border-b border-border flex items-start justify-between gap-4">
          <h2 id="edit-ong-nivel2-title" className="font-heading font-extrabold text-lg" style={{ color: "#1c1c81" }}>
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                ...
                <p className="text-sm font-medium" style={{ color: "#1c1c81" }}>
                  {logoFile
                    ? logoFile.name
                    : logoPreviewUrl
            ...
            {logoError && <p className="mt-1.5 text-xs" style={{ color: "#b91c1c" }}>{logoError}</p>}
          </div>
